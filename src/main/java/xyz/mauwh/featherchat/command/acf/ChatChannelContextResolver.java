...
public final class ChatChannelContextResolver implements ContextResolver<UserChatChannel, BukkitCommandExecutionContext> {

    private final ChatChannelRepository channelRepository;

    public ChatChannelContextResolver(@NotNull ChatChannelRepository channelRepository) {
